...
export default function UploadResumePage() {
  ...
  useEffect(() => {
    ...
    if (saved) {
      ...
      // resumeFile can't be restored because File objects can't be serialized,
      // but we can show the name as a visual hint
      setResumeFile({ name: parsed.resumeFileName });
    }
  }, []);
  ...
  return (
    <div className="flex flex-col max-w-2xl w-full mx-auto px-5 pt-5">
      ...
      <Button onClick={handleTailorResume} disabled={loading} className={"mb-5"}>
